 ...
 * @version 1.0 
 */
public class ConnectionPoolManagerOrigem {
	
	/**
	 * Instancia do objeto.
	 * Singletone
	 */
	private static ConnectionPoolManagerOrigem instance = null;
	
	static {
		if(instance == null) {
			instance = new ConnectionPoolManagerOrigem();
		}
	}
	 ...
	 */
	public static ConnectionPoolManagerOrigem getInstance() {
		if(instance == null) {
			instance = new ConnectionPoolManagerOrigem();
		}
		return instance;
	 ...
	 */
	private ConnectionPoolManagerOrigem() {
		//recuperando configuracoes de acesso ao db
		driver = ResourceLocation.DATABASE_DRIVER_ORIGEM;
		url = ResourceLocation.DATABASE_URL_ORIGEM;
		username = ResourceLocation.DATABASE_USER_ORIGEM;
		password = ResourceLocation.DATABASE_PASS_ORIGEM;
